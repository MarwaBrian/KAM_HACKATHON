    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-lg shadow-md flex flex-col lg:flex-row max-w-4xl w-full">
        ...
        <div className="w-full lg:w-1/2 lg:pl-8 flex flex-col justify-center">
          <button className="w-full bg-blue-500 text-white p-3 rounded-md flex items-center justify-center mb-3">
            <img src={GoogleLogo} alt="Google" className="mr-2 h-6 w-6" />
            Google
          </button>
          <button className="w-full bg-blue-800 text-white p-3 rounded-md flex items-center justify-center mb-3">
            <img src={FacebookLogo} alt="Facebook" className="mr-2 h-6 w-6" />
            Facebook
          </button>
          <button className="w-full bg-blue-600 text-white p-3 rounded-md flex items-center justify-center mb-3">
      ...
      <div className="mt-16 lg:mt-20 lg:absolute lg:bottom-4 text-center w-full">
        <p>
